  ...
  personalityTypes: [
    {
      ...
      background: "radial-gradient(circle at 30% 70%, #FF6B35, #F7931E, #FFD23F)",
      gradient: "bg-gradient-to-br from-orange-600 via-red-600 to-pink-600",
      borderColor: "border-orange-400",
      silhouette: "M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 5.5V6.5C15 7.6 14.1 8.5 13 8.5H11C9.9 8.5 9 7.6 9 6.5V5.5L3 7V9H5V22H7V16H9V22H11V16H13V22H15V16H17V22H19V9H21Z",
    ...
    },
    {
      ...
      background: "radial-gradient(circle at 30% 70%, #4ECDC4, #44A08D, #093637)",
    ...
    },
    {
      ...
      background: "radial-gradient(circle at 30% 70%, #2196F3, #21CBF3, #45B7D1)",
    ...
    },
    {
      ...
      background: "radial-gradient(circle at 30% 70%, #11998e, #38ef7d, #4facfe)",
    ...
    },
    {
      ...
      background: "radial-gradient(circle at 30% 70%, #434343, #000000, #2c3e50)",
